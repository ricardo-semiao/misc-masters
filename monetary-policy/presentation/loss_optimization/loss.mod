...
omega_Pi = 0.7;  % Peso da variância da inflação
omega_Y = 0.3;   % Peso da variância do produto
omega_i = 0;     % Peso da variância da taxa de juros
omega_Q = 0;     % Peso da variância do iQ
...
model;
    ...
    s = b + 1 / tau * (
        ...
        + q(-2) / (Pi * Pi(-1)) 
        + q(-3) / (Pi * Pi(-1) * Pi(-2)) 
        + q(-4) / (Pi * Pi(-1) * Pi(-2) * Pi(-3)) 
        + q(-5) / (Pi * Pi(-1) * Pi(-2) * Pi(-3) * Pi(-4)) 
        + q(-6) / (Pi * Pi(-1) * Pi(-2) * Pi(-3) * Pi(-4) * Pi(-5)) 
        + q(-7) / (Pi * Pi(-1) * Pi(-2) * Pi(-3) * Pi(-4) * Pi(-5) * Pi(-6)) 
        + q(-8) / (Pi * Pi(-1) * Pi(-2) * Pi(-3) * Pi(-4) * Pi(-5) * Pi(-6) * Pi(-7)) 
        + q(-9) / (Pi * Pi(-1) * Pi(-2) * Pi(-3) * Pi(-4) * Pi(-5) * Pi(-6) * Pi(-7) * Pi(-8)) 
        + q(-10) / (Pi * Pi(-1) * Pi(-2) * Pi(-3) * Pi(-4) * Pi(-5) * Pi(-6) * Pi(-7) * Pi(-8) * Pi(-9)) 
        + q(-11) / (Pi * Pi(-1) * Pi(-2) * Pi(-3) * Pi(-4) * Pi(-5) * Pi(-6) * Pi(-7) * Pi(-8) * Pi(-9) * Pi(-10)) 
        + q(-12) / (Pi * Pi(-1) * Pi(-2) * Pi(-3) * Pi(-4) * Pi(-5) * Pi(-6) * Pi(-7) * Pi(-8) * Pi(-9) * Pi(-10) * Pi(-11)) 
        + q(-13) / (Pi * Pi(-1) * Pi(-2) * Pi(-3) * Pi(-4) * Pi(-5) * Pi(-6) * Pi(-7) * Pi(-8) * Pi(-9) * Pi(-10) * Pi(-11) * Pi(-12)) 
        + q(-14) / (Pi * Pi(-1) * Pi(-2) * Pi(-3) * Pi(-4) * Pi(-5) * Pi(-6) * Pi(-7) * Pi(-8) * Pi(-9) * Pi(-10) * Pi(-11) * Pi(-12) * Pi(-13)) 
        + q(-15) / (Pi * Pi(-1) * Pi(-2) * Pi(-3) * Pi(-4) * Pi(-5) * Pi(-6) * Pi(-7) * Pi(-8) * Pi(-9) * Pi(-10) * Pi(-11) * Pi(-12) * Pi(-13) * Pi(-14)) 
        + q(-16) / (Pi * Pi(-1) * Pi(-2) * Pi(-3) * Pi(-4) * Pi(-5) * Pi(-6) * Pi(-7) * Pi(-8) * Pi(-9) * Pi(-10) * Pi(-11) * Pi(-12) * Pi(-13) * Pi(-14) * Pi(-15)) 
        + q(-17) / (Pi * Pi(-1) * Pi(-2) * Pi(-3) * Pi(-4) * Pi(-5) * Pi(-6) * Pi(-7) * Pi(-8) * Pi(-9) * Pi(-10) * Pi(-11) * Pi(-12) * Pi(-13) * Pi(-14) * Pi(-15) * Pi(-16)) 
        + q(-18) / (Pi * Pi(-1) * Pi(-2) * Pi(-3) * Pi(-4) * Pi(-5) * Pi(-6) * Pi(-7) * Pi(-8) * Pi(-9) * Pi(-10) * Pi(-11) * Pi(-12) * Pi(-13) * Pi(-14) * Pi(-15) * Pi(-16) * Pi(-17)) 
        + q(-19) / (Pi * Pi(-1) * Pi(-2) * Pi(-3) * Pi(-4) * Pi(-5) * Pi(-6) * Pi(-7) * Pi(-8) * Pi(-9) * Pi(-10) * Pi(-11) * Pi(-12) * Pi(-13) * Pi(-14) * Pi(-15) * Pi(-16) * Pi(-17) * Pi(-18))
    ); %(B.7)
...
%----------------------------------------------------------------
% 7. Run Simulation and Compute Loss
%----------------------------------------------------------------
resid;    % Verificar resíduos das equações
check;    % Verificar estabilidade das raízes
stoch_simul(order=1, irf=50000,nograph);
...
loss = omega_Pi * variance_Pi + omega_Y * variance_Y + omega_i * variance_i + omega_Q * variance_iQ;


% Display Results
disp('Variance of Pi:'), disp(variance_Pi);
disp('Variance of Y:'), disp(variance_Y);
disp('Variance of i:'), disp(variance_i);
disp('Variance of iQ:'), disp(variance_iQ);
disp('Loss Function:'), disp(loss);