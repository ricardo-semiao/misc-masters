...
var Y C s G Pi L ChiC Ps PQ PB w ChiL F K A b q qbar qCB i iQ D theta nu ksi Pss bMF; // Ps*s included, thus 26 var
...
parameters beta delta psi SStheta phi alpha SSPi tau gbar trho f a1 a2 
            ...
            gamYQE SSY SSG SSC SSD SSL SSw SSs SSqbar SSPB SSPQ SSi lambda Lambda;
...
qMF = lambda*q; // !!!!!!
Lambda * s = 1/tau*(q + qMF(-1)/Pi + qMF(-2)/(Pi*Pi(-1)) + qMF(-3)/(Pi*Pi(-1)*Pi(-2)) + qMF(-4)/(Pi*Pi(-1)*Pi(-2)*Pi(-3)) + qMF(-5)/(Pi*Pi(-1)*Pi(-2)*Pi(-3)*Pi(-4)) + qMF(-6)/(Pi*Pi(-1)*Pi(-2)*Pi(-3)*Pi(-4)*Pi(-5)) + qMF(-7)/(Pi*Pi(-1)*Pi(-2)*Pi(-3)*Pi(-4)*Pi(-5)*Pi(-6)) + qMF(-8)/(Pi*Pi(-1)*Pi(-2)*Pi(-3)*Pi(-4)*Pi(-5)*Pi(-6)*Pi(-7)) + qMF(-9)/(Pi*Pi(-1)*Pi(-2)*Pi(-3)*Pi(-4)*Pi(-5)*Pi(-6)*Pi(-7)*Pi(-8)) + qMF(-10)/(Pi*Pi(-1)*Pi(-2)*Pi(-3)*Pi(-4)*Pi(-5)*Pi(-6)*Pi(-7)*Pi(-8)*Pi(-9)) + qMF(-11)/(Pi*Pi(-1)*Pi(-2)*Pi(-3)*Pi(-4)*Pi(-5)*Pi(-6)*Pi(-7)*Pi(-8)*Pi(-9)*Pi(-10)) + qMF(-12)/(Pi*Pi(-1)*Pi(-2)*Pi(-3)*Pi(-4)*Pi(-5)*Pi(-6)*Pi(-7)*Pi(-8)*Pi(-9)*Pi(-10)*Pi(-11)) + qMF(-13)/(Pi*Pi(-1)*Pi(-2)*Pi(-3)*Pi(-4)*Pi(-5)*Pi(-6)*Pi(-7)*Pi(-8)*Pi(-9)*Pi(-10)*Pi(-11)*Pi(-12)) + qMF(-14)/(Pi*Pi(-1)*Pi(-2)*Pi(-3)*Pi(-4)*Pi(-5)*Pi(-6)*Pi(-7)*Pi(-8)*Pi(-9)*Pi(-10)*Pi(-11)*Pi(-12)*Pi(-13)) + qMF(-15)/(Pi*Pi(-1)*Pi(-2)*Pi(-3)*Pi(-4)*Pi(-5)*Pi(-6)*Pi(-7)*Pi(-8)*Pi(-9)*Pi(-10)*Pi(-11)*Pi(-12)*Pi(-13)*Pi(-14)) + qMF(-16)/(Pi*Pi(-1)*Pi(-2)*Pi(-3)*Pi(-4)*Pi(-5)*Pi(-6)*Pi(-7)*Pi(-8)*Pi(-9)*Pi(-10)*Pi(-11)*Pi(-12)*Pi(-13)*Pi(-14)*Pi(-15)) + qMF(-17)/(Pi*Pi(-1)*Pi(-2)*Pi(-3)*Pi(-4)*Pi(-5)*Pi(-6)*Pi(-7)*Pi(-8)*Pi(-9)*Pi(-10)*Pi(-11)*Pi(-12)*Pi(-13)*Pi(-14)*Pi(-15)*Pi(-16)) + qMF(-18)/(Pi*Pi(-1)*Pi(-2)*Pi(-3)*Pi(-4)*Pi(-5)*Pi(-6)*Pi(-7)*Pi(-8)*Pi(-9)*Pi(-10)*Pi(-11)*Pi(-12)*Pi(-13)*Pi(-14)*Pi(-15)*Pi(-16)*Pi(-17)) + qMF(-19)/(Pi*Pi(-1)*Pi(-2)*Pi(-3)*Pi(-4)*Pi(-5)*Pi(-6)*Pi(-7)*Pi(-8))*Pi(-9)*Pi(-10)*Pi(-11)*Pi(-12)*Pi(-13)*Pi(-14)*Pi(-15)*Pi(-16)*Pi(-17)*Pi(-18)); //(B.7) !!!!!!
end;
